            ...
            <div className="flex items-center justify-between gap-2">
              ...
              <div className="flex items-center gap-2">
                <input
                  ...
                  className={`${classes.inputText} h-8 outline-none bg-gray-1000 border-none rounded-md text-right p-0 text-white pr-3 placeholder:text-gray-400 placeholder:text-sm`}
                  placeholder="0.00"
                />
