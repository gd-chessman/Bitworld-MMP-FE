    ...
    return (
        <div >
            <DropdownMenu>
                ...
                <DropdownMenuContent 
                    className='w-max max-w-[130px] 2xl:max-w-[200px] px-2 py-2 bg-white dark:bg-theme-neutral-1000 border border-gray-200 dark:border-gray-800 rounded-lg shadow-lg transition-colors' 
                    align="end" 
                    style={{ width: '200px' }}
                >
                    ...
                    <div className='flex items-center justify-evenly gap-4 mt-3'>
                        <Moon 
                            className="cursor-pointer transition-colors w-7" 
